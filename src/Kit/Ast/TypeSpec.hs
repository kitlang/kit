...
data TypeSpec
  ...
  | FunctionTypeSpec TypeSpec [TypeSpec] TypeSpecArgs Bool
...
typeSpecParams (FunctionTypeSpec _ params _ _) = params
typeSpecParams _                               = []
...
typeSpecPosition (FunctionTypeSpec t _ _ _) = typeSpecPosition t
