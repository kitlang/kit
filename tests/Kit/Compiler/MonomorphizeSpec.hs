module Kit.Compiler.MonomorphizeSpec where
  ...
  testParams = [(makeTypeSpec "A", makeTypeSpec "A1"), (makeTypeSpec "B", makeTypeSpec "B1")]
  ...
  spec = do
    describe "Monomorphizes expressions" $ do
      ...
      it "Substitutes monomorph type parameters in annotations" $ do
        shouldBe
          (monomorphizeExpr testParams (e (TypeAnnotation (e This) (makeTypeSpec "A"))))
          (e (TypeAnnotation (e This) (makeTypeSpec "A1")))
        shouldBe
          (monomorphizeExpr testParams (e (TypeAnnotation (e This) (makeTypeSpec "B"))))
