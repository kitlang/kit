...
curl -vvv -T kitlang-$VERSION-$CC-latest.pkg -ukitplummer:$BINTRAY_API_KEY \
  -H "X-Bintray-Publish: 1" -H "X-Bintray-Override: 1" \
  https://api.bintray.com/content/kitplummer/kit-macos/kitlang/0.1.0/kitlang-$VERSION-$CC-latest.pkg
